...
import computer from '../../../../public/images/home/computerpoeriferal.png'
import Component from '../../../../public/images/home/component.png'
import desktop from '../../../../public/images/home/desktop.png'
import laptop from '../../../../public/images/home/laptop.png'
import printer from '../../../../public/images/home/printer.png'
import screen from '../../../../public/images/home/screen.png'
import table from '../../../../public/images/home/table.png'
import server from '../../../../public/images/home/server.png'

interface Props {
    props: string;
}

const MenuMid: React.FC<Props> = ({ props }) => {
    ...
    return (
        <>
            <div className={`header-menu style-one ${fixedHeader ? 'fixed' : 'absolute'} top-0 left-0 right-0 w-full md:h-[74px] h-[56px] ${props}`} style={{marginBottom: "5%", marginTop:"5%",backgroundColor:"#0D81C7"}}>
                            ...
                            <div className="menu-main h-full max-lg:hidden">
                                <ul className='flex items-center gap-8 h-full'>
                                                ...
                                                <div className="flex justify-between py-8">
                                                    <div className="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                        <div className="nav-item">
                                                            <div className="text-button-uppercase pb-2">Computer</div>
                                                            <ul>
                                                                <li>
                                                                    <div
                                                        ...
                                                        <div className="nav-item">
                                                            <div className="text-button-uppercase pb-2">Mobile</div>
                                                            <ul>
                                                                <li>
                                                                    <div
                                                                        onClick={() => handleTypeClick('shirt')}
                                                        ...
                                                        <div className="nav-item">
                                                            <div className="text-button-uppercase pb-2">Server</div>
                                                            <ul>
                                                                <li>
                                                                    <div
                                                        ...
                                                        <div className="nav-item">
                                                            <div className="text-button-uppercase pb-2">Desktop</div>
                                                            <ul>
                                                                <li>
                                                                    <div
                                    ...
                                    <li className='h-full relative'>
                                        <Link href="/blog/list" className={`text-button-uppercase duration-300 h-full flex items-center justify-center ${pathname.includes('/blog/list') ? 'active' : ''}`}>
