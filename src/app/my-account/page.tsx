...
const MyAccount = () => {
    ...
    const [userEmail, setUserEmail] = useState('');
     // 2. Check for access_token on component mount
     useEffect(() => {
        ...
        if (userData) {
            try {
                ...
                // Fallback: force logout or handle error
                router.push('/login');
            }
        }
    }, [router]);
                        ...
                        <div className="left md:w-1/3 w-full xl:pr-[3.125rem] lg:pr-[28px] md:pr-[16px]">
                            <div className="user-infor bg-surface lg:px-7 px-4 lg:py-10 py-5 md:rounded-[20px] rounded-xl">
                                <div className="heading flex flex-col items-center justify-center">
                                    ...
                                    <div className="name heading6 mt-4 text-center">{userName}</div>
                                    <div className="mail heading6 font-normal normal-case text-secondary text-center mt-1">{userEmail}</div>
                                </div>
                                ...
                                <form>
                                    ...
                                    <div className='grid sm:grid-cols-2 gap-4 gap-y-5 mt-5'>
                                        ...
                                        <div className="email">
                                            ...
                                            <input className="border-line mt-2 px-4 py-3 w-full rounded-lg" id="email" type="email" defaultValue={userEmail} placeholder={userEmail} required />
                                        </div>
